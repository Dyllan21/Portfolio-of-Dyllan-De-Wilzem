...
# create the screen
screen: Surface | SurfaceType = pygame.display.set_mode((800, 500))

# Background
background = pygame.image.load('Space landscape.png')

# Sounds
mixer.music.load('the-next-level-retro-chiptune-dance-instrumental-space-invaders-137339.mp3')
mixer.music.play(-1)
...
for i in range(num_of_enemies):
    enemyImg.append(pygame.image.load('enemy-spaceship-sprite-11562897082efa3h4ejq2B.png'))
